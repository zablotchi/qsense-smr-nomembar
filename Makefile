...
BENCHS = src/linkedlist src/linkedlist-harris_opt src/linkedlist-harris_opt_tcmalloc src/linkedlist-harris_opt_jemalloc src/linkedlist-michael src/hashtable src/hashtable-java src/hashtable-copy src/skiplist src/skiplist-fraser src/skiplist-herlihy_lf src/skiplist-seq src/skiplist-lock src/skiplist-herlihy_lb src/skiplist-pugh src/skiplist-string-pugh src/bst src/bst-seq_internal src/bst-howley src/bst-aravind src/noise/ src/tests/ src/bst-tk/ src/linkedlist-smr-hart src/linkedlist-smr-no-membar src/linkedlist-qsbr-hart src/linkedlist-qsbr src/linkedlist-smr src/linkedlist-smr-harris_opt src/linkedlist-qsbr-harris_opt src/linkedlist-smr-no-membar-harris_opt src/linkedlist-qsbr-smr-hybrid src/linkedlist-smr-lazy src/linkedlist-smr-no-membar-igor_opt/
...
LFBENCHS = src/linkedlist src/linkedlist-harris_opt src/linkedlist-harris_opt_tcmalloc src/linkedlist-harris_opt_jemalloc src/linkedlist-michael src/hashtable src/skiplist src/skiplist-fraser src/skiplist-herlihy_lf src/bst src/bst-howley src/bst-aravind src/linkedlist-smr-hart src/linkedlist-smr-no-membar src/linkedlist-smr src/linkedlist-smr-harris_opt src/linkedlist-smr-no-membar-harris_opt src/linkedlist-smr-lazy src/linkedlist-smr-no-membar-igor_opt/
...
lfll_hybrid_harris_opt:
	$(MAKE) "GC=0" "LOCK=TICKET" "VERSION=DEBUG" src/linkedlist-qsbr-smr-hybrid	
...
lfll_mr: lfll_smr_lazy lfll_smr_harris_opt lfll_qsbr_harris_opt lfll_smr_no_membar_harris_opt lfll_smr_no_membar_igor_opt lfll_hybrid_harris_opt
