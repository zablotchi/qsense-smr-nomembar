...
infile="./compare4_lazymembar_highmemory"
...
plot    infile i 0 using 1:2 title "smr-no-membar" with linespoint ls 2, \
        ...
        infile i 0 using 1:8 title "smr-lazy-membar" with linespoint ls 3, \
...
plot    infile i 1 using 1:2 title "smr-no-membar" with linespoint ls 2, \
        ...
        infile i 1 using 1:8 title "smr-lazy-membar" with linespoint ls 3, \
...
plot    infile i 2 using 1:2 title "smr-no-membar" with linespoint ls 2, \
        ...
        infile i 2 using 1:8 title "smr-lazy-membar" with linespoint ls 3, \
...
plot    infile i 3 using 1:2 title "smr-no-membar" with linespoint ls 2, \
        ...
        infile i 3 using 1:8 title "smr-lazy-membar" with linespoint ls 3, \
...
plot    infile i 4 using 1:2 title "smr-no-membar" with linespoint ls 2, \
        ...
        infile i 4 using 1:8 title "smr-lazy-membar" with linespoint ls 3, \
