...
plot    infile i 0 using 1:2 title "original" with linespoint ls 2, \
        infile i 0 using 1:5 title "no membar" with linespoint ls 3, \
        infile i 0 using 1:8 title "nmb + ordered rlist" with linespoint ls 4, \
        infile i 0 using 1:11 title "nmb + ordered rlist + periodic_op" with linespoint ls 5, \
        infile i 0 using 1:14 title "nmb + ordered rlist + periodic_time" with linespoint ls 7, \

set title "Updates = 10%"

plot    infile i 1 using 1:2 title "original" with linespoint ls 2, \
        infile i 1 using 1:5 title "no membar" with linespoint ls 3, \
        infile i 1 using 1:8 title "nmb + ordered rlist" with linespoint ls 4, \
        infile i 1 using 1:11 title "nmb + ordered rlist + periodic_op" with linespoint ls 5, \
        infile i 1 using 1:14 title "nmb + ordered rlist + periodic_time" with linespoint ls 7, \
